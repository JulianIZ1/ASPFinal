<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="UpdatePatient.aspx.cs" Inherits="ASPFinal.UpdatePatient" %>
<asp:Content ID="ContentPlaceHolder1" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <table class="auto-style1" style="color:white; background-color:black">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDOB" style="width:90%;" runat="server" CausesValidation="True" ToolTip="Enter Date of Birth"></asp:TextBox>
                <br />
