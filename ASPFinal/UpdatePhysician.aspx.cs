            ...
            if (!IsPostBack)
            {
                ...
                if (!string.IsNullOrEmpty(Request.QueryString["ID"]))
                {
                    ...
                    else
                    {
                        ...
                        lblPhysicianID.Text = dataSet.Tables[0].Rows[0]["patient_id"].ToString();
                        ...
                        txtOfficePhone.Text = dataSet.Tables[0].Rows[0]["home_phone"].ToString();
                        txtPersonalPhone.Text = dataSet.Tables[0].Rows[0]["cell_phone"].ToString();
                        ...
                        txtSpecialty.Text = dataSet.Tables[0].Rows[0]["specialty"].ToString();
